    ...
    <div class="main-container">
      <div class="container-large align-center">
        <div class="article w-richtext">
          ...
          <p>By submitting content to our website, you grant Rashed Mazumdar Technical Services LLC an irrevocable, worldwide, royalty-free license to use, modify, distribute, and display your content as needed. You confirm that you have the necessary rights to grant this license.</p>
          
          <ol start="5" role="list">
            <li><strong>Termination of Agreement</strong></li>
          </ol>
          <p>These Terms remain in effect until terminated by either party. Rashed Mazumdar Technical Services LLC reserves the right to terminate or suspend your access to the website at any time without notice, for any reason. Provisions intended to survive termination will remain in effect.</p>
          
          <ol start="6" role="list">
            <li><strong>Disclaimer of Warranties</strong></li>
          </ol>
          <p>Your use of this website is at your own risk. Services and content are provided "as is" and "as available," without any warranties, express or implied. Rashed Mazumdar Technical Services LLC makes no guarantees regarding the accuracy, reliability, or availability of the site and its services.</p>
          
          <ol start="7" role="list">
            <li><strong>Limitation of Liability</strong></li>
          </ol>
          <p>Under no circumstances shall Rashed Mazumdar Technical Services LLC or its affiliates be liable for any direct, indirect, incidental, or consequential damages arising from the use or inability to use our services. This includes, but is not limited to, loss of profits, business disruption, data loss, or reputational harm.</p>
          
          <ol start="8" role="list">
            <li><strong>External Links</strong></li>
          </ol>
          <p>Our website may contain links to third-party websites. Rashed Mazumdar Technical Services LLC does not endorse or assume responsibility for any external content, products, or services available on these websites.</p>
          ...
          <p>These Terms represent the entire agreement between you and Rashed Mazumdar Technical Services LLC regarding website use. Additional terms may apply when using certain services or third-party content.</p>
          
          <ol start="11" role="list">
            <li><strong>Changes to Terms</strong></li>
          </ol>
          <p>Rashed Mazumdar Technical Services LLC reserves the right to update these Terms at any time. Any changes take effect upon posting, and continued use of the website implies acceptance of the revised Terms.</p>
        </div>
      </div>
    </div>
</div>
