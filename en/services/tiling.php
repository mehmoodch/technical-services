	...
	<div class="page-wrapper">
		<div id="Top" class="back-to-top-container">
			<div class="back-to-top-button-container"><a href="#Top" class="button-round button-round-small w-inline-block">
				<img src="https://cdn.prod.website-files.com/64c93da6f9f661cffa20dfee/64c93da6f9f661cffa20e10d_icon-chevron-up.svg" alt="" /></a></div>
		</div>
		<?php
		...
		<div class="section bg-gray-4 w-condition-invisible">
			<div class="w-layout-grid grid-halves fullwidth-grid-halves reverse-direction">
				<div class="container align-center">
					<div class="service-rich-text w-richtext">
						<h2><strong>Finding Your Individual Environmental Fit™</strong></h2>
						<h3>Length of Ramp</h3>
						<p>The first thing to consider when choosing a ramp is the amount of space available to construct the ramp. The length of the ramp is usually calculated using a 1 inch to 1-foot ratio. For example, if the entry point is 10 inches above the ground, the minimum recommended ramp length is 10 feet¹. If the entry point is higher than a few feet, using turns or switchbacks (images shown on screen) will conserve space while keeping the incline at a safe and manageable level.</p>
						<p><br /></p>
						<h3>Material</h3>
						<p>The two primary choices for ramp material are wood and aluminum. Wooden ramps are the best choice for matching existing decks or porches. These ramps, however, require an advanced building skill set or professional help to install and require maintenance to prevent the wood from rotting. Although less visually appealing, aluminum ramps are generally easier to install, require much lower maintenance, and can be easily modified and adjusted. Steel and concrete ramps are also</p>
						<p><br /></p>
						<h3>Additional ADA Standards²</h3>
						<p>The Americans with Disabilities Act recommends:</p>
						<p><br /></p>
						<ul role="list">
							<li>A 5 by 5-foot landing at the top and bottom of the ramp.</li>
							<li>A maximum run of 30 feet before a turn or platform.</li>
							<li>A minimum width of 36 inches.</li>
							<li>Handrails that are at least 34 inches high.</li>
						</ul>
						<ol role="list">
							<li><em>http://www.adawheelchairramps.com/wheelchair-ramps/ada-guidelines.aspx</em></li>
							<li><em>http://www.adawheelchairramps.com/wheelchair-ramps/ada-guidelines.aspx</em></li>1.
						</ol>
					</div>
