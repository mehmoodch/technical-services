  ...
  <div class="main-container text-center left">
    <div class="w-layout-grid grid-halves fullwidth-grid-halves">
      <div class="container-large page-title align-center no-padding-on-mob">
        ...
        <h1 class="display-heading-2">Other Home Modifications</h1>
        <div class="service-rich-text w-richtext">
          ...
          <p>Our team specializes in modifying homes using universal design principles to create spaces that are both functional 
            ...
            here to help.</p>
          <p><strong>Some of the additional modifications we offer include:</strong></p>
          <p><br /></p>
          <ul role="list">  
          ...
          <p>Experience matters, and our skilled professionals have years of expertise in home modifications. However, we believe 
            ...
            we would expect in our own homes.</p>
        </div>
