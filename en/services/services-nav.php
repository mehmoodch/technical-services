          ...
          <a href="#" class="brand right-justify w-nav-brand">
            <div class="code-embed-4 w-embed w-script">
              <!-- <script src="../static.elfsight.com/platform/platform.js" async></script> -->
               <div>
                  <img style="width: auto; height: 82px;" src="../../cdn.prod.website-files.com/64c93da6f9f661cffa20dfee/rashedmts-logo.png">
               </div>
            ...
            <nav role="navigation" class="nav-menu nav-menu-right-aligned w-nav-menu">
              ...
              <div data-hover="false" data-delay="0" class="dropdown w-dropdown">
                <div class="nav-link w-dropdown-toggle">
                  <div>Services</div><img src="https://cdn.prod.website-files.com/64c93da6f9f661cffa20dfee/64c93da6f9f661cffa20e0e1_icon-dropdown-arrow.svg" alt="" class="dropdown-icon" />
                </div>
                    ...
                    <div class="service-wrapper mob-only w-dyn-list">
                      <div role="list" class="navigation-link-wrapper mob-only w-dyn-items">
                        <div role="listitem" class="w-dyn-item">
                            <a href="service-categories/handyman-services.html"
                        ...
                        <div role="listitem" class="w-dyn-item">
                            <a href="service-categories/home-modification.html" class="navigation-link-l w-inline-block">
              ...
              <div data-delay="200" data-hover="false" class="dropdown w-dropdown">
                ...
                <nav class="dropdown-list w-dropdown-list">
                  <div class="w-layout-grid dropdown-grid">
                    <a href="our-story.html" class="dropdown-link w-dropdown-link">Our Story</a>
                    <a href="our-story/become-a-craftsman.html" class="dropdown-link w-dropdown-link">Become a Craftsman</a>
                    <a href="our-story/franchise-opportunities.html" class="dropdown-link w-dropdown-link">Franchise  Opportunities</a>
                    <a href="our-story/reviews.html"  class="dropdown-link w-dropdown-link">Reviews</a>
                    <a href="our-story/faqs.html" class="dropdown-link w-dropdown-link">FAQ&#x27;s</a>
                    <a href="our-story/project-gallery.html" class="dropdown-link w-dropdown-link">Project Gallery</a>
                    <a href="our-story/in-the-news.html"  class="dropdown-link hide w-dropdown-link">Meet The Team</a>
                    <a href="our-story/in-the-news.html"  class="dropdown-link w-dropdown-link">In The News</a>
                    <a href="our-story/video-center.html"  class="dropdown-link w-dropdown-link">Video Center</a>
                    <a href="our-story/blog.html"  class="dropdown-link w-dropdown-link">Blog</a>
                    <a href="our-story/special-offers.html"  class="dropdown-link w-dropdown-link">Special Offers</a>
                  </div>
                </nav>
              </div>
